...
@CucumberOptions(features = "src/test/resources/features/buscas.feature", glue = "br.com.automacao.steps", plugin = {
		"pretty", "html:target/site" }, monochrome = true, dryRun = false
